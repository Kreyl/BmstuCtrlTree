...
const LedSmoothChunk_t lsqSmoothFailure[] = {
...
const LedSmoothChunk_t lsqSmoothFadeout[] = {
        {csSetup, 180, 0},
        {csEnd}
};

const LedSmoothChunk_t lsqSmoothDischarged[] = {
        {csSetup, 0, LED_TOP_BRIGHTNESS},
        {csWait, 207},
        {csSetup, 0, 0},
        {csWait, 207},
...
const LedSmoothChunk_t lsq5VNotCharging[] = {
        {csSetup, 0, LED_TOP_BRIGHTNESS},
        {csEnd}
};
const LedSmoothChunk_t lsq5VCharging[] = {
